...
bool DAQInterface::SendMonitoringData(const std::string& subject, const std::string& json_data, const std::string& device, int64_t timestamp){
  
  
  return m_services->SendMonitoringData(subject, json_data, device, timestamp);
